...
// ---------------------------------------------------------
			...
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '30px', 'lineheight' => '35px', 'face' => 'Ubuntu', 'style' => 'bold', 'character'  => 'latin', 'color' => '#333333'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '28px', 'lineheight' => '22px', 'face' => 'Ubuntu', 'style' => 'bold', 'character'  => 'latin', 'color' => '#333333'));
								
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '18px', 'face' => 'Ubuntu', 'style' => 'bold', 'character'  => 'latin', 'color' => '#333333'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '22px', 'lineheight' => '18px', 'face' => 'Ubuntu', 'style' => 'bold', 'character'  => 'latin', 'color' => '#333333'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '20px', 'lineheight' => '18px', 'face' => 'Ubuntu', 'style' => 'bold', 'character'  => 'latin', 'color' => '#333333'));

			$options['h6_heading'] = array(
								'id' => 'h6_heading',
								'std' => array( 'size' => '13px', 'lineheight' => '20px', 'face' => 'Ubuntu', 'style' => 'bold', 'character'  => 'latin', 'color' => '#8f9090'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '35px', 'lineheight' => '36px', 'face' => 'Ubuntu', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '14px', 'lineheight' => '17px', 'face' => 'Ubuntu', 'style' => 'bold', 'character'  => 'latin', 'color' => '#797979'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '10px', 'lineheight' => '30px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#797979'));
...
// ---------------------------------------------------------
		...
		$options['mail'] = array(
							"name" => __('Mail URL', CURRENT_THEME),
							"desc" => __('Mail URL', CURRENT_THEME),
							"id" => "mail",
							"std" => "#",
							"type" => "text"
		);
