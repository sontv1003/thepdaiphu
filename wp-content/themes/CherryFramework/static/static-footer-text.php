...
<div id="footer-text" class="footer-text">
	...
	<?php if( is_front_page() ) { ?>
		More Interior Design WordPress Themes at <a rel="nofollow" href="http://www.templatemonster.com/category/interior-design-wordpress-themes/" target="_blank">TemplateMonster.com</a>
	<?php } ?>
</div>